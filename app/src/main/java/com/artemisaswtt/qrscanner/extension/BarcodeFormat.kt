...
fun BarcodeFormat.toColorId(): Int {
    return when (this) {
        BarcodeFormat.QR_CODE -> R.color.dark_green
        BarcodeFormat.DATA_MATRIX, BarcodeFormat.AZTEC, BarcodeFormat.PDF_417, BarcodeFormat.MAXICODE -> R.color.green_light
        else -> R.color.green
    }
}